...
- Added `agentforge backlog status --project-root <path>` to print deterministic pre-cycle backlog visibility (active backlog-file count, completed/quarantined counts, unattended exclusions, and active scoped item IDs/titles).
